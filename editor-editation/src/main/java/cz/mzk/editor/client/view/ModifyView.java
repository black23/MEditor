...
import cz.mzk.editor.client.view.window.PersistentUrlWindow;
...
public class ModifyView
        extends ViewWithUiHandlers<ModifyUiHandlers>
        implements MyView {
    ...
    /*
     * (non-Javadoc)
     * @see cz.mzk.editor.client.presenter.ModifyPresenter.MyView#
     * fromClipboard()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see cz.mzk.editor.client.presenter.ModifyPresenter.MyView# toClipboard
    ...
    /*
     * (non-Javadoc)
     * @see cz.mzk.editor.client.presenter.ModifyPresenter.MyView#getEditor
